...
const text =
  [
    ['Population: One - Population: One is a top-down zombie survival game for two players. The objective is to be the last player standing after a relentless zombie horde attacks.', 'Population: One - A chilling soundtrack and ominous countdown forewarn the danger that lies ahead. A helpful hint tries to add levity to a serious situation.', 'Population: One - Avoid the obstacles and the zombies and outrun your opponent to win. Use your limited special power charges sparingly.'],
    ['Locavorus - Locavorus aims to manage the complete life cycle of hospitality customer service, from before they patronise the business to well after their meal.', 'Locavorus - Customers can make service requests directly to the staff without having to signal for their attention, reducing inefficiency and increasing customer satisfaction.', 'Locavorus - Orders are sent directly to the kitchen, so customers get their food more quickly and more accurately. Dietary notes can be passed as well.', 'Locavorus - The restaurant can manage their menu here, to keep track of their offerings, while letting customers view the food options online.', 'Locavorus - Locavorus caters to both customers and restaurants.'],
    ['Love Confidently - Finished in one night for the UN Women Hackathon, Love Confidently aims to help women in developing countries by educating them about contraception.', 'Love Confidently - All women have different needs. We set up a simple survey to help narrow down the most appropriate and relevant method for each woman, while also allowing them to browse and compare the different methods on their own.', 'Love Confidently - We used geolocation to find all medical supply stores near you, which would ideally provide information about what stores carried which contraceptives and how much they cost.', 'Love Confidently - We implemented socket.io to enable real time communication. The idea was that women in need could contact a medical professional to get immediate advice on their contraception.', 'Love Confidently - We used Twilio SMS to implement a tracking feature where women opting in would receive a message every day at the same time.', 'Love Confidently - The response would be tracked and a follow-up message might be sent depending on the patient\'s history.'],
    ['Locavorus Rex - Locavorus Rex is an application for restaurants and other food businesses to manage their reservations, queue and orders.', 'Locavorus Rex - Customers can make reservations quickly and easily, and an email confirmation is sent soon after.', 'Locavorus Rex - Queuing is hassle-free. Just enter your details and be contacted when your table is ready. You can check your estimated wait at any time.', 'Locavorus Rex - The system automatically notifies you when your wait is over.', 'Locavorus Rex - Customers can also make takeaway orders online.', 'Locavorus Rex - Easy online payment is integrated via Stripe.', 'Locavorus Rex - Businesses can manage their reservations, queues and orders from a dashboard.', 'Locavorus Rex - The kitchen receives orders directly, which are prioritised automatically by time, and include future orders e.g. takeaways and reservations.', 'Locavorus Rex - Restaurants can also get a quick glance at their active and completed orders/invoices.'],
    ['Via Postale - Via Postale is a travel-focused social media site that is best described as Instagram x Pinterest x TripAdvisor.', 'Via Postale - Users post their travel experiences, complete with description and rating. We try to prefill the fields from image EXIF data to simplify the process.', 'Via Postale - Users can view other users\' trips and activities and follow those they like.', 'Via Postale - Users can save activities they like for future reference.', 'Via Postale - Users can plan their own trips around activities they have saved.']
  ]
